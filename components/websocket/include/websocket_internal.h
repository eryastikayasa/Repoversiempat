...
/* AudioEngine produces 20ms/320B frames. Keep 400ms of headroom so a
 * short TLS/WebSocket stall does not immediately back-pressure the mic. */
#define WS_TX_QUEUE_LENGTH 20
